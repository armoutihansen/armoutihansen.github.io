...
import { experience, resolveExperience } from "./experience";

describe("website experience adapter", () => {
  it("preserves the approved experience selection and presentation", () => {
  ...
  it("rejects an unknown selected record identifier", () => {
    expect(() =>
      resolveExperience([
        { id: "unknown-role", bullets: ["Editorial bullet."], logo: "/logo.svg" }
      ])
    ).toThrow(/Unknown Professional record experience id: unknown-role/);
  });
});
